...
* Fix - WordPress 7.0 compatibility updates and code optimizations

= 1.33.1 =
* Release Date - 11 May 2026*

* Fix - Resolved an occasional payment confirmation error caused by malformed data
...
* Feat - Add option to manually configure connection to Airwallex
...
* Add - Support for skipping the billing address during express checkout

= 1.24.1 =
* Release Date - 19 September 2025*

* Perf - Added caching for API requests to reduce unnecessary calls

= 1.24.0 =
* Release Date - 9 September 2025*

* Add - Support for FunnelKit Upsell

= 1.23.4 =
* Release Date - 27 August 2025*

* Fix - Prevent incorrect order status updates due to shared webhooks across multiple stores

= 1.23.3 =
* Release Date - 11 August 2025*

* Fix - Improved the guest checkout experience for Drop-in and redirect card payments
